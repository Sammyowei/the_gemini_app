abstract class RoutePathConfig {
  static String initial = '/';
  static String initialSecond = 'splash';
  static String onboarding = '/onboarding';
  static String authScreen = '/auth';
  static String signIn = '/auth/signin';
  static String signUpOnboarding = '/auth/account_creation';
  static String signUpScreen = '/auth/sign_up';
  static String authOtp = '/auth/validate';
  static String password = '/auth/sign_up/password';
